...
- My blog article: [yougan.cc/xiaohongshu-mcp](https://www.yougan.cc/xiaohongshu-mcp)

> **📌 Please read before submitting a PR: [Contributing Guide](./CONTRIBUTING.md)**

**If you encounter any issues, be sure to check [Common Issues and Solutions](https://github.com/byte01001/xiaohongshu-mcp/issues/56) first.**

After checking the **Common Issues** list, if you still can't resolve your deployment problems, we strongly recommend using another tool I've created: [byte01001/x-mcp](https://github.com/byte01001/x-mcp). This tool doesn't require deployment - you only need a browser extension to drive your MCP, making it more user-friendly for non-technical users.
...
Download pre-compiled binaries for your platform directly from [GitHub Releases](https://github.com/byte01001/xiaohongshu-mcp/releases):
...
docker pull byte01001/xiaohongshu-mcp
```

Docker Hub URL: [https://hub.docker.com/r/byte01001/xiaohongshu-mcp](https://hub.docker.com/r/byte01001/xiaohongshu-mcp)
...
wget https://raw.githubusercontent.com/byte01001/xiaohongshu-mcp/main/docker/docker-compose.yml
...
docker build -t byte01001/xiaohongshu-mcp .
```
...
2. Or use **Docker to install xiaohongshu-mcp**, refer to:
   - [Install xiaohongshu-mcp with Docker](https://github.com/byte01001/xiaohongshu-mcp#:~:text=%E6%96%B9%E5%BC%8F%E4%B8%89%EF%BC%9A%E4%BD%BF%E7%94%A8%20Docker%20%E5%AE%B9%E5%99%A8%EF%BC%88%E6%9C%80%E7%AE%80%E5%8D%95%EF%BC%89)
   - [X-MCP Project Page](https://github.com/byte01001/x-mcp/)
